create database modul_3_database_new;
use modul_3_database_new;
...
select * from modul_3_database.vi_tri;
...
select * from modul_3_database.bo_phan;
...
select * from modul_3_database.trinh_do;
...
INSERT INTO `modul_3_database`.`nhan_vien` (`ma_nhan_vien`, `ho_va_ten`, `ngay_sinh`, `so_cmnd`, `luong`, `sdt`, `email`, `dia_chi`, `ma_vi_tri`, `ma_trinh_do`, `ma_bo_phan`) VALUES ('1', 'Nguyễn Văn An', '1970-11-07', '456231786', '10000000', '0901234121', 'annguyen@gmail.com', '295 Nguyễn Tất Thành, Đà Nẵng', '1', '3', '1');
INSERT INTO `modul_3_database`.`nhan_vien` (`ma_nhan_vien`, `ho_va_ten`, `ngay_sinh`, `so_cmnd`, `luong`, `sdt`, `email`, `dia_chi`, `ma_vi_tri`, `ma_trinh_do`, `ma_bo_phan`) VALUES ('2', 'Lê Văn Bình', '1997-04-09', '654231234', '7000000', '0934212314', 'binhlv@gmail.com', '22 Yên Bái, Đà Nẵng', '1', '2', '2');
INSERT INTO `modul_3_database`.`nhan_vien` (`ma_nhan_vien`, `ho_va_ten`, `ngay_sinh`, `so_cmnd`, `luong`, `sdt`, `email`, `dia_chi`, `ma_vi_tri`, `ma_trinh_do`, `ma_bo_phan`) VALUES ('3', 'Hồ Thị Yến', '1995-12-12', '999231723', '14000000', '0412352315', 'thiyen@gmail.com', 'K234/11 Điện Biên Phủ, Gia Lai', '1', '3', '2');
INSERT INTO `modul_3_database`.`nhan_vien` (`ma_nhan_vien`, `ho_va_ten`, `ngay_sinh`, `so_cmnd`, `luong`, `sdt`, `email`, `dia_chi`, `ma_vi_tri`, `ma_trinh_do`, `ma_bo_phan`) VALUES ('4', 'Võ Công Toản', '1980-04-04', '123231365', '17000000', '0374443232', 'toan0404@gmail.com', '77 Hoàng Diệu, Quảng Trị', '1', '4', '4');
INSERT INTO `modul_3_database`.`nhan_vien` (`ma_nhan_vien`, `ho_va_ten`, `ngay_sinh`, `so_cmnd`, `luong`, `sdt`, `email`, `dia_chi`, `ma_vi_tri`, `ma_trinh_do`, `ma_bo_phan`) VALUES ('5', 'Nguyễn Bỉnh Phát', '1999-12-09', '454363232', '6000000', '0902341231', 'phatphat@gmail.com', '43 Yên Bái, Đà Nẵng', '2', '1', '1');
INSERT INTO `modul_3_database`.`nhan_vien` (`ma_nhan_vien`, `ho_va_ten`, `ngay_sinh`, `so_cmnd`, `luong`, `sdt`, `email`, `dia_chi`, `ma_vi_tri`, `ma_trinh_do`, `ma_bo_phan`) VALUES ('6', 'Khúc Nguyễn An Nghi', '2000-11-08', '964542311', '7000000', '0978653213', 'annghi20@gmail.com', '294 Nguyễn Tất Thành, Đà Nẵng', '2', '2', '3');
INSERT INTO `modul_3_database`.`nhan_vien` (`ma_nhan_vien`, `ho_va_ten`, `ngay_sinh`, `so_cmnd`, `luong`, `sdt`, `email`, `dia_chi`, `ma_vi_tri`, `ma_trinh_do`, `ma_bo_phan`) VALUES ('7', 'Nguyễn Hữu Hà', '1993-01-01', '534323231', '8000000', '0941234553', 'nhh0101@gmail.com', '4 Nguyễn Chí Thanh, Huế', '2', '3', '2');
INSERT INTO `modul_3_database`.`nhan_vien` (`ma_nhan_vien`, `ho_va_ten`, `ngay_sinh`, `so_cmnd`, `luong`, `sdt`, `email`, `dia_chi`, `ma_vi_tri`, `ma_trinh_do`, `ma_bo_phan`) VALUES ('8', 'Nguyễn Hà Đông', '1989-09-03', '234414123', '9000000', '0642123111', 'donghanguyen@gmail.com', '111 Hùng Vương, Hà Nội', '2', '4', '4');
INSERT INTO `modul_3_database`.`nhan_vien` (`ma_nhan_vien`, `ho_va_ten`, `ngay_sinh`, `so_cmnd`, `luong`, `sdt`, `email`, `dia_chi`, `ma_vi_tri`, `ma_trinh_do`, `ma_bo_phan`) VALUES ('9', 'Tòng Hoang', '1982-09-03', '256781231', '6000000', '0245144444', 'hoangtong@gmail.com', '213 Hàm Nghi, Đà Nẵng', '2', '4', '4');
INSERT INTO `modul_3_database`.`nhan_vien` (`ma_nhan_vien`, `ho_va_ten`, `ngay_sinh`, `so_cmnd`, `luong`, `sdt`, `email`, `dia_chi`, `ma_vi_tri`, `ma_trinh_do`, `ma_bo_phan`) VALUES ('10', 'Nguyễn Công Đạo', '1994-01-08', '755434343', '8000000', '0988767111', 'nguyencongdao12@gmail.com', '6 Hoà Khánh, Đồng Nai', '2', '3', '2');
select*from modul_3_database.nhan_vien;
...
select*from modul_3_database.loai_khach;
...
select *
from khach_hang
where round(datediff(curdate(),khach_hang.ngay_sinh) /365,0)>=18 and round(datediff(curdate(),khach_hang.ngay_sinh)/365,0)<=50
...
select kh.ma_khach_hang, kh.ho_ten, count(hd.ma_khach_hang)
from loai_khach lk inner join khach_hang kh on lk.ma_loai_khach=kh.ma_loai_khach
...
--  ten_dich_vu, ngay_lam_hop_dong, ngay_ket_thuc,
...
from loai_khach lk  right join khach_hang kh on lk.ma_loai_khach=kh.ma_loai_khach
...
from hop_dong
where month(hop_dong.ngay_lam_hop_dong) in (1,3) and year(hop_dong.ngay_lam_hop_dong)=2021)
...
select 
dv. ma_dich_vu, dv.ten_dich_vu, dv.dien_tich, dv.so_nguoi_toi_da, dv.chi_phi_thue, ldv.ten_loai_dich_vu
...
select dvdk.ma_dich_vu_di_kem, ho_ten, ten_dich_vu_di_kem
...
select 
hd.ma_hop_dong, nv.ho_va_ten , kh.ho_ten ,
  kh.so_dien_thoai , dv.ten_dich_vu, tien_dat_coc , hd.ngay_lam_hop_dong,
ifnull(sum(so_luong),0) so_luong_dich_vu_di_kem 
from nhan_vien nv  right join  hop_dong  hd on nv.ma_nhan_vien=hd.ma_nhan_vien
join khach_hang kh on hd.ma_khach_hang=kh.ma_khach_hang
left join dich_vu dv on hd.ma_dich_vu=dv.ma_dich_vu
 left join hop_dong_chi_tiet hdct on hd.ma_hop_dong=hdct.ma_hop_dong
where (month(ngay_lam_hop_dong) in (10,11,12) and year(ngay_lam_hop_dong)=2020 ) 
and (month(ngay_lam_hop_dong) not in (1,2,3,4,5,6 and year (ngay_lam_hop_dong)=2021))
group by hd.ma_hop_dong ;
...
select dvdk.ma_dich_vu_di_kem, dvdk.ten_dich_vu_di_kem ,sum(so_luong)
...
select 
nv.ma_nhan_vien, nv.ho_va_ten, td.ten_trinh_do, bp.ten_bo_phan, nv.sdt, nv.dia_chi, count(hd.ma_hop_dong)
from bo_phan bp join nhan_vien nv on bp.ma_bo_phan=nv.ma_bo_phan
...
delete
-- select 
-- nv.ma_nhan_vien, nv.ho_va_ten, hd.ma_hop_dong
...
select 
kh.ma_khach_hang, kh.ho_ten, lk.ten_loai_khach, sum(ifnull(dv.chi_phi_thue,0) + ifnull(hdct.so_luong,0) * ifnull(dvdk.gia,0))tong_tien
from loai_khach lk join khach_hang kh on lk.ma_loai_khach=kh.ma_loai_khach
join hop_dong hd on kh.ma_khach_hang= hd.ma_khach_hang
join dich_vu dv on hd.ma_dich_vu= dv.ma_dich_vu
join hop_dong_chi_tiet hdct on hd.ma_hop_dong=hdct.ma_hop_dong
join dich_vu_di_kem dvdk on hdct.ma_dich_vu_di_kem=hdct.ma_dich_vu_di_kem
...
set gia=gia*2
where dich_vu_di_kem.ma_dich_vu_di_kem not in(
select tem.ma_dich_vu_di_kem from(
select dvdk.ma_dich_vu_di_kem
from dich_vu_di_kem dvdk join hop_dong_chi_tiet hdct on dvdk.ma_dich_vu_di_kem=hdct.ma_dich_vu_di_kem
join hop_dong hd on hdct.ma_hop_dong=hd.ma_hop_dong
where so_luong>=11 and year(ngay_lam_hop_dong)=2020
) tem
);
...
select 
nv.ma_nhan_vien, nv.ho_va_ten, nv.email, nv.sdt, nv.ngay_sinh, nv.dia_chi, 1 'type' 
from nhan_vien nv
union all
select 
kh.ma_khach_hang, kh.ho_ten, kh.email, kh.so_dien_thoai, kh.ngay_sinh, kh.dia_chi, 2 'type' 
from khach_hang kh
