    ...
    <div class="row">
        <div class="col-lg-12 mt-3 text-lg-center">
            <form class="d-flex">
                ...
                <button class="bg-success btn btn-outline-dark" type="submit">add</button>
            </form>
        </div>
        <div class=" col-lg-12">
            ...
            <table id="tableStudent" class="table table-striped table-bordered" style="width:100%">
                ...
                <tr>
                    <th scope="col">stt</th>
                    <th scope="col">maBenhNhan</th>
                    <th scope="col">tenBenhNhan</th>
                    <th scope="col">ngayNhapVien</th>
                    <th scope="col">ngayRaVien</th>
                    <th scope="col">lyDoNhapVien</th>
                    <th scope="col">maBenhAn</th>
...
<%--                    <th scope="col">Properties</th>--%>
                ...
                <tbody>
                <c:forEach items="${benhNhanList}" var="bn" varStatus="loop">
                    ...
                    <tr>
                        ...
                        <td>${bn.ngayRaVien}</td>
                        <td>${bn.lyDoNhapVien}</td>
                        <td>${bn.maBenhAn.maBenhAn}</td>
...
<%--                        <td>${employee.address}</td>--%>
                        ...
                        <td><a class="bg-success btn btn-outline-dark"
                               href="BenhNhanServlet?action=editshow&maBenhNhan=${bn.maBenhNhan}">Edit</a></td>
...
<%--                               href="EmployeeServlet?action=properties&employee_id=${bn.maBenhAn}">Properties</a></td>--%>
                        ...
                        <td>
                            ...
                            <button type="button" class="btn btn-danger" data-toggle="modal"
                                    data-target="#exampleModal-${bn.maBenhAn}">
                                Delete
                            </button>

                            <!-- Modal -->
                            <div class="modal fade" id="exampleModal-${bn.maBenhAn}" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Ban co muon xoa benh nhan ${bn.tenBenhNhan}
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-success" data-dismiss="modal">Close
                                            </button>
                                            <a class=" btn btn-outline-danger"
                                               href="BenhNhanServlet?action=delete&maBenhNhan=${bn.maBenhNhan}">Delete</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
